...
- Check if there was a change in coefficients between different time periods (e.g. before NAFTA in 1996)
- Check the approach done by other literature, how our approach fits with it, and what we can say about their approaches and our approaches given the regression we've run 
